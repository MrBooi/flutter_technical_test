...
import 'package:dvt_weather_app/features/current_weather/presentation/widgets/current_weather_forecast_list.dart';
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          const CurrentWeatherForecastList(),
